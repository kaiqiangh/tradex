...
1. `docs/TradeX_PRD_v1.0_RevA.md` — normative PRD (source of truth);
2. `docs/TradeX_UI_Prototype_Spec_v1.0_RevA.md` — UI / prototype target specification;
3. `docs/TradeX_Prototype_Coverage_Matrix_v1.0_RevA.md` — requirement ↔ prototype traceability;
