...
**Generated / 生成日期:** 2026-09-23

Paths below are relative to the repository root. Hashes describe the current local file bytes after the S01/S02 IPC additions, user-approved S03 DeepSeek model clarification, S08 market-state contract additions, and S18 Trading 212 Demo wire/UI and terminal-attempt deletion eligibility additions, not a released ZIP or a passing execution system. The unchanged prototype sources were reviewed at main@6c4b267. Regenerate this manifest whenever a listed file changes.

以下路径相对仓库根目录。哈希描述 S01/S02 IPC 增补、用户批准的 S03 DeepSeek 模型澄清、S08 市场状态契约增补及 S18 Trading 212 Demo wire/UI 与终态 attempt 删除资格增补后的本地文件字节，不表示已打包发布或执行系统验收通过。未修改的原型源码审查基线为 main@6c4b267。清单中文件变化后须重新生成。
...
| `docs/TradeX_Frontend_ARD_v1.0_RevC.md` | English Frontend ARD | 1047 | `c39a1e22ae5634dd73ff44eb40e75ad03db36ca02e5e75f8071ecc77b0ca34a3` |
| `docs/zh/TradeX_Frontend_ARD_v1.0_RevC_zh.md` | 中文 Frontend ARD | 1045 | `7f9ada0056e9dd0474f1f586bd3bf1620d64ae1cfabad1cb3aad695f05c79b02` |
| `docs/TradeX_Backend_ARD_v1.0_RevC.md` | English Backend ARD | 2807 | `6b2e4b84142a57cca7d8c7c3d80f8435e2ba3e174e53564a0f4831a71aa6832a` |
| `docs/zh/TradeX_Backend_ARD_v1.0_RevC_zh.md` | 中文 Backend ARD | 2805 | `67cbf8e6965e1a30a49753428b93f15f93f0ac4ebc94ecb32f173c4423bec06e` |
...
| `docs/TradeX_Prototype_QA_Report_v1.0_RevC.md` | English QA Report | 188 | `d4f0b6dfcb2098077175dcd7a9bc048f290819135ce146c3788381f915622bd0` |
| `docs/zh/TradeX_Prototype_QA_Report_v1.0_RevC_zh.md` | 中文 QA Report | 188 | `000587479a3f61a8553e07cffb684d812164cd420efb9e189a5d5b5b6bafac51` |
