...
- [S03 网关生命周期验收](s03-gateway-evidence.md)：#11 固定 CLIProxyAPI 生命周期、真实进程探测/冲突/退避/清理、公共 Settings 页面和串行 Standards/Spec 审查；#13 路由/回退/配额验收已完成，下一项为 #14 入门验收。
