...
- [S04 Thread 历史切片验收](s04-thread-evidence.md)：#17 schema v6、Thread create/list/get、snapshot/replay/subscribe、历史恢复和 390/768 浏览器证据；#18/#19 runtime/cancel/retry 仍待完成。
