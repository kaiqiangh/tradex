...
- [S04 Turn 流式验收](s04-turn-evidence.md)：#18 不可变 Turn 来源、受限 Codex stdio 适配器、流式 typed timeline、provider attempts、故障隔离和浏览器/CLI smoke 证据；#19 取消/重试仍待完成。
