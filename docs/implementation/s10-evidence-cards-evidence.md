...
| `npm run typecheck`、`npm run build`、`npm run test:unit` | PASS — unit 5 |
...
| CUA 浏览器 `http://127.0.0.1:1420/` | PASS — 股票/现货卡片、synthetic label、Trade disabled CTA；1280/768/390 的 `scrollWidth` 分别为 1265/753/375；venue region/status 语义元素可见；warn/error 日志为空 |
