...
function orderAmount(order: PortfolioOrder) {
  ...
  if (order.notional != null) return `${order.notional}${order.currency ? ` ${order.currency}` : ''}`;
  return 'Unavailable';
}
