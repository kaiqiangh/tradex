...
export function useDomainProjection<T extends DomainProjection>(kind: 'workspace' | 'account' | 'model-gateway' | 'model' | 'risk', id: string | undefined, read: (value: unknown) => Projection<T>) {
